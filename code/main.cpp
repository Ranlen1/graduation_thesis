...
int main()
{
    ...
    Shader ourShader("../code/vertexShader.vs", "../code/fragmentShader.fs");
    ...
    unsigned char *data = stbi_load("../code/container.jpg", &width, &height, &nrChannels, 0);
    ...
    data = stbi_load("../code/awesomeface.png", &width, &height, &nrChannels, 0);
