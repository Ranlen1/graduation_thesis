...
Open GL je povazovano za aplikacni programovaci rozhrani (API), ktera uzivatelum poskytuje sadu
...
Vztupni data se ukladaji do pameti \gls{gpu} pomoci Vertex Buffer Objektu \gls{vbo}. Ten v sobe
dokaze ulozit velke mnozstvi dat, diky cemuz jich posilame vice najednou a vyuzivame vysokou
propustnost \gls{gpu}. Kdyz jsou data ulozena v \gls{gpu}, vertex shader k nim ma primy pristup.
\cite{learn_opengl}
...
k promennym uvnitr vertex shaderu. Dalsim dulezitym objektem je Vertex Array Object, do ktereho se
uklada jak jsou data v VBO usporadana a jak se maji propojit s vertex shadery. 
\cite{learn_opengl} 
