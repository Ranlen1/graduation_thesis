...
\subsection{CPU vs. GPU}
    Tradičně běžela většina apklikací sekvenčně na procesorech s centrální výpočetní jednotkou
    (\gls{cpu}), která provádí instrukce 
    jednu po druhé. V průběhu 20. století se výkon \gls{cpu} významě zlepšoval až na
    bilion operací za sekundu, čímž se mohly zlepšévat grafické aplikace a využívat náročnější
    ...
    dostatečně výkonné na složíté výpočti, a proto už v 70. a 80.
...
\chapter{to do}
    mozna pridat trochu historie kompileru u C a CPP
